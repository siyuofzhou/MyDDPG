...
class JointNetWork_V2:
    ...
    def __init__(self,state_dim,action_dim):
        ...
        self.__policy_learn_rate = 1e-3
        self.__Q_learn_rate = 1e-3
    ...
    def __build(self):
        reg_l2 = tf.contrib.layers.l2_regularizer(1e-3)
        
        self.target_Q = self.__network(self.target_state_input,'target',online=False)
        self.online_action,self.online_Q = self.__network(self.online_state_input,'online',reg=reg_l2,bn_training=self.bn_training)
